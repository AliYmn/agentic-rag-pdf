...
other code can consume. The trade-off is one extra model call per question, which
is justified because document-grounded correctness is the project's primary goal.
